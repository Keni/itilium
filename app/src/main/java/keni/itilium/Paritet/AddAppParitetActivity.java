 ...
 */
public class AddAppParitetActivity extends AppCompatActivity
{
    ...
    private void getJSON()
    {
        ...
        class GetJSON extends AsyncTask<Void, Void, String>
        {
            ...
            {
                super.onPreExecute();
                loading = ProgressDialog.show(AddAppParitetActivity.this, "Загрузка", "Подождите...", false, false);
            }
            ...
            protected String doInBackground(Void... params)
            {
                ...
                String s = rh.sendGetRequest(Config.URL_GET_OBJECTS_PARITET);
                return s;
            }
        }
    ...
    private void loadObjects()
    {
        ...
        try
        {
            ...
            ArrayList<ObjectsAndEngineers> objectsAndEngineersList = new ArrayList<>();
            ...
            for (int i = 0; i < result.length(); i++)
            {
                ...
                objectsAndEngineersList.add(new ObjectsAndEngineers(obj_id, name));
            }

            ArrayAdapter<ObjectsAndEngineers> adapter = new ArrayAdapter<ObjectsAndEngineers>(this, R.layout.spinner_objects_item, objectsAndEngineersList);
    ...
    private void addApp()
    {
        ...
        class AddApp extends AsyncTask<Void, Void, String>
        {
            ...
            {
                super.onPostExecute(s);
                Toast.makeText(AddAppParitetActivity.this, s, Toast.LENGTH_LONG).show();
            }
            ...
            protected String doInBackground(Void... v)
            {
                ...
                RequestHandler rh = new RequestHandler();
                String res = rh.sendPostRequest(Config.URL_ADD_APP_PARITET, params);
                return res;
            }
        }
        ...
        switch (item.getItemId())
        {
            case R.id.done:
                if (initiator_name.isEmpty() || description.isEmpty())
                    Toast.makeText(AddAppParitetActivity.this, "Не все поля заполнены", Toast.LENGTH_SHORT).show();
                else
                {
                    addApp();
                    onBackPressed();
